  ...
  >
    <div class="flex h-16 items-center justify-between px-5 flex-shrink-0">
      <RouterLink :to="{ name: 'Dashboard' }" class="flex items-center gap-2">
        ...
        <h1 class="text-xl font-bold text-text-primary">نظام التوظيف</h1>
      </RouterLink>
      <button
...
const allNavLinks = shallowRef([
  ...
  {
    name: 'إدارة التوظيف',
    icon: BriefcaseIcon, // أيقونة الحقيبة للوظائف
    // نكتفي بالتحقق من إحدى صلاحيات التوظيف لفتح المجموعة
  ...
  },
  {
    ...
    icon: BuildingOfficeIcon, // أيقونة المباني للإدارات والمدن
  ...
  {
    name: 'إعدادات النظام',
    icon: Cog6ToothIcon, // أيقونة الترس للإعدادات
